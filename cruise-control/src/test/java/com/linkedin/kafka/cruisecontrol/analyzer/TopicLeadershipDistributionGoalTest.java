...
public class TopicLeadershipDistributionGoalTest {
    ...
    @Test
    public void testOptimize() throws OptimizationFailureException {
        ClusterModel clusterModel = generateClusterModel();

        TopicLeadershipDistributionGoal goal = initializeGoal();
    ...
    @Test
    public void testActionAcceptance() throws OptimizationFailureException {
        ClusterModel clusterModel = generateClusterModel();
    ...
    private TopicLeadershipDistributionGoal initializeGoal() {
        TopicLeadershipDistributionGoal goal = new TopicLeadershipDistributionGoal();
